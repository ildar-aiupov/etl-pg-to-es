...
def main():
    ...
    es_params = {
        ...
        "index_name": os.environ.get("INDEX_NAME_MOVIES", default="movies"),
    }
        ...
        try:
            ...
            for portion in postgres.load_portion():
                for entry in portion:
                    ...
                    filmwork_id = entry["id"]
                    response = elastic.save_to_es(properties, filmwork_id)
                    count += 1
                    if response.status_code in [200, 201]:
                        ...
                        logging.info(
                            f"Entry with id={filmwork_id} is not updated. "
